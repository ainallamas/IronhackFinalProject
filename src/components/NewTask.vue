    ...
    <div class="container">
      <div v-if="publishing">
        <form>
          <button
            @click="publish"
            class="save-button button is-link is-centered submit-button button is-size-3 has-text-weight-bold" type="submit"
          >
            POST NEW TASKS
          </button>
        </form>
      ...
      <div v-else class="newtask">
        ...
        <form @submit.prevent="onSubmit">
          ...
          <div class="field">
            <div class="save-button control columns">
              <div class="column">
                <button
                  class="button is-link is-centered submit-button is-size-5 has-text-weight-bold is-fullwidth"
                  type="submit"
                >
                  Save changes
                </button>
